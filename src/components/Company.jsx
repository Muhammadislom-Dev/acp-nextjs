    ...
    <section className="company-section py-6 ">
      <div className="flex justify-center bg-companyCeo py-10">
        <div className="container">
          <div className="flex flex-wrap-reverse justify-center gap-4 md:grid grid-cols-2 md:justify-between gap-x-16 ">
            <div>
              <h2 className="text-black font-semibold text-base sm:text-lg md:text-2xl pb-2">
                COMPANY CEO
              </h2>
              <p className="text-xs md:text-sm text-zinc-600">
                We, the ALSTAR team, are pleased to welcome you and share
                important news. We have taken a new course of development,
                striving to reach new heights and exceed the expectations of our
                customers. Our company has always set itself the task of being
                innovative and advanced in the automatic transmission industry.
                Today we present to you a new milestone in our journey to
                success. We not only update our product range, but also invest
                significant resources in research and development of new
                technologies. This allows us to offer you products that combine
                the highest quality, innovative design and environmental
                sustainability. Thank you for your support and trust. We invite
                you to join our journey and work together to create a better
          ...
          <div className="flex flex-col justify-start w-8/12 pt-14 gap-4">
            ...
            <div className="bg-companyStrategyBg py-1 px-2 md:py-3 md:px-4 rounded-md">
              <p className="text-white text-xs md:text-base">
                ...
                production capacity and quality of products, developing foreign
                markets.
              </p>
            </div>
          </div>
