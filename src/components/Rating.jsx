...
const Rating = () => {
  return (
    <section className="rating-section px-12 py-8">
      <div className="container">
        <div className="rating-blog bg-ratingBg px-5 sm:px-10 py-8 rounded-2xl shadow-2xl shadow-ratingShadow">
          ...
          <div className="flex items-center mt-6 gap-4 sm:gap-0 sm:justify-between flex-wrap sm:flex-nowrap justify-center">
            ...
            <div className="flex flex-col">
              <p className="text-ratingNumColor text-4xl md:text-5xl  xl:text-6xl font-semibold">
                60<span className="text-black">+</span>
              </p>
            ...
            {/* <div className="hidden lg:block">
              <img
                src="http://alstar.uz/assets/raketa-c55363ae.png"
                alt="alstar rating"
              />
            </div> */}
          </div>
